...
datapath = ""#
probnames =probnames =[  "phishing" , "a9a",  "mushrooms","splice","w8a","madelon", "gisette_scale", "covtype", "rcv1_train"];
for probname in probnames
  ...
  ## Running methods
  OUTPUTS = [];
  method_names = ["SVRG", "2D", "2Dsec", "CMprev","CMgauss", "DFPgauss", "DFPprev"];  # Curvature matching methods: CMgauss,  CMprev
