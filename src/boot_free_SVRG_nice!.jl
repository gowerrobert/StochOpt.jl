"""
    initiate_free_SVRG_nice(prob::Prob, options::MyOptions; unbiased=true)
...
"""
    boot_free_SVRG_nice!(prob::Prob, method, options::MyOptions)
...
"""
    reset_free_SVRG_nice(prob::Prob, method, options::MyOptions)
