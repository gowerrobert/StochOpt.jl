function descent_DFPprev(x::Array{Float64},prob::Prob,options::MyOptions,mth::Method, N::Int64,d::Array{Float64})
  # DFPprev: A 2nd variant of SVRG that uses an action matching Hessian estimate
