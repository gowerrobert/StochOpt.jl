...
Plot two upper-bounds of the expected smoothness constant (simple and Bernstein), 
...
Plot upper bounds of the stepsizes corresponding to the simple and Bernstein upper bounds, 
