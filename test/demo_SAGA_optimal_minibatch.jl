...
## Load problem
datapath = ""
probname = "mushrooms"; # "splice"   # Data tested in paper: w8a mushrooms gisette_scale,  madelon  a9a  phishing  covtype splice  rcv1_train  liver-disorders_scale
...
## List of minibatch sizes
batchsizelist = [1, 2, 5, 10]; 

###### SAGA + nice minibatching
for tau in batchsizelist
    println("\nCurrent minibatch size: ", tau);
